...
* [gate.cat](https://github.com/BGMLAI/gate.cat) - _Apache-2.0 local deterministic action veto for coding agents that blocks named destructive shell, cloud, database, repository, and secret-handling command classes before execution._
