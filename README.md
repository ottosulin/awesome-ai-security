...
* [Aegis-DevOps](https://github.com/moneytool/aegis-devops) - _Pre-execution policy verifier for AI DevOps agents. Checks kubectl, Terraform, cloud CLI, Helm, git and SQL commands against a signed constraint store, and only trusts rules whose source is authorized to assert them._
