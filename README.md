...
* [SidClaw](https://github.com/sidclawhq/platform) - _Approval and accountability layer for agentic AI. Provides identity, policy engine, human-in-the-loop approval workflows, and tamper-proof hash-chain audit trail. SDK (Apache 2.0) with 13 framework integrations._
