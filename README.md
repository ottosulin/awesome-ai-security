...
* [Recusal](https://github.com/philpaz/recusal) - _Deterministic, zero-dependency verifier that refuses an AI agent's tool call before it runs (PASS/RETRY/FAIL verdicts, no model in the decision path). Ships as a Claude Code PreToolUse hook and plugin with a framework-neutral Python core, tamper-evident audit log, and a published threat model. Apache-2.0._
