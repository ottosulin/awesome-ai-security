...
* [aguara](https://github.com/garagon/aguara) - _Static security scanner for AI agent skills and MCP server configurations. 148+ YAML rules across 13 categories, deterministic, offline, zero dependencies. Single Go binary._
