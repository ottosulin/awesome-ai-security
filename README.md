...
* [aip-identity](https://github.com/The-Nexus-Guard/aip) - _Decentralized identity and trust protocol for AI agents. Ed25519 keypairs, signed vouch chains, E2E encrypted messaging, and cryptographic skill signing — no central authority required._
