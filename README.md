...
* [ContextGuard](https://github.com/sunilgentyala/contextguard) - _Zero-trust middleware library for MCP deployments: cryptographic server attestation, capability binding for rug-pull detection, and semantic tool-definition scanning. Research prototype with an evaluation corpus._
