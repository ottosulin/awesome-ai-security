...
* [HOL Guard](https://github.com/hashgraph-online/hol-guard) - _Local-first runtime security for AI coding agents. Intercepts shell commands, secret reads, and MCP changes before execution with configurable protection levels._
