...
* [OpenLeash](https://github.com/openleash/openleash) - _Local-first authorization sidecar for AI agents. Evaluates YAML policies and returns ALLOW / DENY / REQUIRE_APPROVAL decisions, issues PASETO v4.public proof tokens that any counterparty can verify offline, and supports human-in-the-loop approval workflows with append-only audit log. SDKs for TypeScript, Python, and Go. Apache-2.0._
