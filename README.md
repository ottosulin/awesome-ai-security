...
* [halo-record](https://github.com/bkuan001/halo-record) - _Tamper-evident runtime records for AI agents: every tool and model call lands in an append-only, hash-chained audit log that anyone can verify without trusting the operator, plus an open witness protocol that proves completeness. Zero dependencies, Python and TypeScript._
