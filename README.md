...
* [shim-cli](https://github.com/GetSHIM/shim-cli) - _Local hooks for Claude Code, Codex and Copilot CLI that detect secrets and personal data, mask them in Claude Code tool results before the model reads them, and report prompt-injection markers found in those results._
