...
* [Agentic Control Plane](https://github.com/agentic-control-plane/acp-install) - _Policy check on every agent tool call before it executes — allow, ask, or deny across Claude Code, Codex, Cursor, and MCP clients. Spend caps, PII redaction, and an audit trail that ties each call back to the originating human. MIT open core, runs hosted or fully local._
