...
* * [AgentGate](https://agent-gate-rho.vercel.app/) - _Open-source security firewall for OpenClaw AI agents. Enforces ALLOW/DENY/REQUIRE_APPROVAL policies on tool calls with real-time Telegram approval notifications, Firebase Firestore audit logs, and an AI Policy Wizard that converts English descriptions into regex rules._
