...
* [SandBase Harness](https://github.com/sandbaseai/sandbase-harness) - _Self-hosted, local-first agent runtime combining approval and permission policies, credential vaults, audit and replay, and per-session Docker or Kubernetes sandbox backends; its local backend is intended only for trusted development._
