...
### MCP Security
* [HostDeFi Safety MCP](https://hostdefi.com/api/v1/mcp) - _Hosted MCP server + keyless REST API for token-risk grading (Solana + 7 EVM chains); lets agents check contract/tokens before interacting_
