...
* [numbat](https://github.com/perplexityai/numbat) - _Endpoint visibility into AI agent activity by Perplexity. Live monitoring through hooks, plugins, and OTLP/HTTP logs with local CEL-based detection rules. Optional pre-action blocking and forensic reconstruction from on-disk session artifacts. Single Go binary, Apache 2.0._
