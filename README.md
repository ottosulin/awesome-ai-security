...
* [leakproof](https://github.com/acunningham-ship-it/leakproof) - _Local-first secret-egress firewall for AI coding assistants (Claude Code / Cursor / aider). Intercepts outbound requests and redacts credentials before they reach the model API; also ships as a git pre-commit hook. Zero cloud, MIT._
