...
* [Bounded Agents](https://github.com/xmuruaga/bounded-agents) - _Reference implementation of the Agentic Principal Chain (APC), an external authorization layer for multi-agent systems that attenuates delegated authority across agents and tools and blocks prohibited action compositions using execution history. [Paper](https://arxiv.org/abs/2608.15888)._
