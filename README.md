...
* [Koma](https://github.com/swnotmetal/Project-Koma) - _Three-layer defense middleware for TypeScript/Node.js AI apps: semantic prompt-injection filter, audio validation with rate limiting, and token-gated split-store. MIT licensed, available as npm packages (`koma-gate`, `koma-scout`, `koma-core`)._
