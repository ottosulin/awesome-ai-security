...
* [Omega Walls](https://github.com/synqratech/omega-walls) - _Open-source stateful prompt injection defense for RAG and agent pipelines. Adds a runtime trust boundary across untrusted content, model context, memory, and tools to catch distributed attacks and freeze risky actions._
