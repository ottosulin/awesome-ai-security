...
* [IronClaw](https://github.com/IronSecCo/ironclaw) - _Security-hardened runtime that sandboxes AI agent tool-calls in gVisor, with a human approval gateway, encrypted task queues, and a signed and attested supply chain (cosign, SBOM, SLSA). Open source under AGPL-3.0._
