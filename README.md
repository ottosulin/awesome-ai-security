...
* Subcanopy Guard - _Context-aware indirect prompt injection scanner for AI agent tool outputs. Sliding-window instruction density plus stylometric discontinuity. 86.5% caught on AgentDojo v1, 0.85 ms per scan, zero runtime dependencies._
