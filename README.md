...
* [brood-box](https://github.com/stacklok/brood-box) - _Run AI coding agents (Claude Code, Codex, OpenCode) inside hardware-isolated microVMs with COW snapshot isolation, DNS-aware egress control, and Cedar-based MCP authorization profiles._
