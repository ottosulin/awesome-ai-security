...
* [modelaudit](https://github.com/promptfoo/modelaudit) - _Security scanner for AI/ML model files by Promptfoo. Static analysis detects malicious code, backdoors, and security vulnerabilities in ML model files without ever loading or executing them._
