...
* [Prism Scanner](https://github.com/aidongise-cell/prism-scanner) - _Open-source security scanner for AI agent skills, plugins, and MCP servers. Full lifecycle coverage: pre-install code analysis with taint tracking, post-uninstall residue detection. Supports ClawHub, MCP, npm, pip._
