...
* [AgentAudit](https://agentaudit.dev) - _Security audit registry for AI agent packages (MCP, LangChain, CrewAI). Provides trust scores, vulnerability findings, and multi-agent consensus for verifying package safety before installation._
