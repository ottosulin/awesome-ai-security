...
* [Breaking Agent Backbones: Evaluating the Security of Backbone LLMs in AI Agents](https://arxiv.org/abs/2510.22620) - _b³ benchmark evaluating the security of backbone LLMs in AI agents across 194,331 adversarial attacks and 34 models; finds reasoning capability (not model size) correlates with security. [ICLR 2026]_
