...
* [AEGIS (Pilot Protocol)](https://github.com/pilot-protocol/aegis) - _Local, offline firewall for AI agents. Scans untrusted content reaching an agent (peer messages, skill files, memory notes, MCP configs, web/bash output) and blocks prompt injection, jailbreaks, and infrastructure-impersonation before it's acted on. No cloud dependency._
