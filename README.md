...
* [OrcaPromptVault](https://github.com/Continuum-AI-Corp/OrcaPromptVault) - _Reference corpus of system prompts, tool schemas and skill definitions from 43 shipping AI products; 44 of the files are recorded off the wire with a command that reproduces each, so an extracted prompt can be checked against one instead of taken on trust._
