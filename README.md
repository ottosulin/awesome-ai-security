...
* [Signet](https://github.com/Prismer-AI/signet) - _Cryptographic action receipts for AI agents. Ed25519 signing, hash-chained audit trail, bilateral co-signing, policy engine, and transparent MCP proxy. Rust core compiled to WASM (TypeScript) and PyO3 (Python). Offline-verifiable, no SaaS dependency._
* [OpenSandbox](https://github.com/alibaba/OpenSandbox) - _Secure, Fast, and Extensible Sandbox runtime for AI agents. Multi-language SDKs, Docker/Kubernetes runtimes, gVisor/Kata Containers/Firecracker isolation. CNCF Landscape project._
