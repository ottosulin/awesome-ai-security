...
* [Violin](https://github.com/Strategic-Automation/violin) - _Supervised, agentic Hermes Agent pentest profile: 31 skill-based playbooks (OWASP Top 10, API Top 10, LLM Top 10) with interactive scoping, scope validation, and approval gates for authorised recon, exploit validation, and reporting. Installs with `hermes profile install https://github.com/Strategic-Automation/violin`. Hermes-native, no extra API keys._
