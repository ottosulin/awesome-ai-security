...
* [tool-call-guard](https://github.com/binaydhakal/tool-call-guard) - _Deny-by-default policy gate for AI agent tool calls: wildcard allowlists, argument validation, rate caps, human-approval hooks that fail closed, dry-run mode, and an audit trail. One JSON policy enforced by matching JavaScript and Python implementations._
