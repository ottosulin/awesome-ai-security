...
* [ai-evaluation](https://github.com/future-agi/ai-evaluation) - _Evaluation framework for AI workflows with 50+ metrics, LLM-as-Judge augmentation, and guardrail scanners (jailbreak, PII, prompt-injection)._
