...
* [ClawSec](https://clawsec.cc) - _Security audit platform for AI agent skills. Provides automated 5-tier security assessments, configuration auditing, and vulnerability detection for Claude Code skills and MCP server packages._
* [ClawSearch](https://clawsearch.cc) - _Security-first discovery engine for AI agent skills. Trust Score ratings, knowledge graph analysis, and pre-install security guard (npm: clawsearch-guard) to vet skills before installation._
