...
* [SUNGLASSES](https://github.com/sunglasses-dev/sunglasses) - _Open-source input firewall for AI agents that runs locally. Scans text, files, PDFs, images and QR codes for prompt injection, credential leaks and data exfiltration with 1,554 patterns across 118 categories. Ships as a CLI, Python API, MCP server and Claude Code hook._
