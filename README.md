...
* [SecHelix](https://github.com/omarmohelal/SecHelix) - _Agent Skill for application-security review of repositories you are authorized to test. Maps trust boundaries, sends each candidate finding to a separate verifier that tries to refute it, requires regression proof for High and Critical issues, and ends with a fail-closed release verdict_
