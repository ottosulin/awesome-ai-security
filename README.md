...
* [Bifrost](https://github.com/maximhq/bifrost) - _Go-native AI gateway that centralizes guardrails, rate limits, and fine-grained access controls across LLM and MCP traffic._
