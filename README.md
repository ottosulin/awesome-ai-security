...
* [Knowledge Delta Skills](https://github.com/sergeyizmailov/knowledge-delta-skills) - _Two security skills in a portable SKILL.md collection: secure-coding (secure defaults and review across JS/Node/HTML/API/auth/DB/upload paths, plus AI-generated-code vulnerability patterns) and js-obfuscation (JavaScript protection, anti-automation and anti-debugging for authorized testing). Claude Code, Codex, Cursor, Gemini CLI, opencode._
