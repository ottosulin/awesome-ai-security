...
* [AI Security Labs](https://github.com/blueaisecurity/ai-security-labs) - _Docker-based labs that recreate real AI security failures locally with no API key: prompt injection, MCP tool poisoning, and an agent hijack modelled on EchoLeak (CVE-2025-32711). Each lab has a full write-up, including the attempts that failed before the attack landed._
