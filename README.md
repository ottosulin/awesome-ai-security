...
* [Lumi Eggcracker](https://github.com/noqt/Lumi-Eggcracker) - _NOQT's Apache-2.0 native-Linux kill switch for unapproved local-AI workloads matching either of two qualified content profiles. Its hosted proof lets people fork the repo and test the bounded process-tree kill mechanism on a disposable GitHub runner without installing Eggcracker or downloading a model._ [[Hosted proof](https://github.com/noqt/Lumi-Eggcracker/blob/main/TRY_IT.md)]
