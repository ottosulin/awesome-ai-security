...
* [AISecure](https://github.com/FORIFOR/AISecure) - _Local-first preflight that inspects text and Office/PDF files before they reach ChatGPT, Claude or Gemini, with a best-effort in-page stop and no external calls. Publishes its own measured detection recall (0.30 on a 60-case labelled corpus) and the categories it detects zero times._
