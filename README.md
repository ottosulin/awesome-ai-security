...
* [APort](https://aport.io/) - _Agent passport and policy-verification infrastructure for AI agents, with signed decisions, capability limits, and framework integrations._
