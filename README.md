...
* [agentgate](https://github.com/ciceroyang/agentgate) - _Control plane for the tools agents run: inventories MCP servers and other agent tooling, records which scanners actually ran for each record, and refuses to report clean when a required part is unmeasured. Public evidence index, policy checks, SARIF output, GitHub Action. AGPL-3.0._
