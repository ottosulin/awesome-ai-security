...
* [Parallax](https://github.com/agent-defense/parallax) - _Rust runtime guardrails for AI agents: intercepts tool calls, blocks threats, redacts secrets. One binary, one YAML._
