...
* [AgentVeil Protocol](https://agentveil.dev) - _Trust and reputation infrastructure for AI agents. W3C DID identity (Ed25519), EigenTrust peer reputation with sybil detection and collusion cluster analysis, hash-chained audit trail anchored to IPFS, and attestation dispute resolution. Production API and Python SDK._
