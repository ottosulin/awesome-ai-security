...
* [PickySteve](https://github.com/KernelLord/pickysteve) - _MCP stdio server and OpenAI-compatible proxy that routes coding-agent prompts to the right skill via hybrid retrieval and cross-encoder rerank, with an ONNX prompt-injection gate that scans both the raw request and every retrieved document before context assembly. MIT licensed._
