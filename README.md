...
* [ATR (Agent Threat Rules)](https://github.com/Agent-Threat-Rule/agent-threat-rules) - _Open-source detection rules for AI agent threats. 108 regex rules covering prompt injection, tool poisoning, credential exfiltration across 9 categories. Used by Cisco AI Defense. MIT licensed._* [Skill Safe](https://skillsafe.online) - _Free hosted security checker for AI agent skills and MCP servers, producing traceable findings and explicit scan limitations._
