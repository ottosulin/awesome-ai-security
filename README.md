...
* [MARGINAL](https://github.com/SignalLayerLabs/Marginal) - _Local-first runtime governor for AI coding agents that detects proven no-progress repetition, records decision evidence, starts in Shadow Mode, and only enables narrow Codex tool enforcement after repository-local evidence; Claude Code and OpenCode integrations are observe-only._
