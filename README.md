...
* [Code Audit System](https://github.com/UserB1ank/code-audit-system) - _CVE-oriented multi-agent code audit skill for Claude Code. Parallel agents trace sources to sinks, build weaponized POCs, validate findings against live Docker deployments, discard unverified issues, and generate CVE-ready reports._
